	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('HACKER')">
			<li><a class="fNiv"><spring:message	code="master.page.hacker" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="application/hacker/list.do"><spring:message code="master.page.hacker.action.1" /></a></li>
					<li><a href="position/hacker/list.do"><spring:message code="master.page.hacker.action.2" /></a></li>					
				</ul>
			</li>
		</security:authorize>
