...
<form:form action="hacker/register.do"
	...
	<fieldset>
		<legend align="left">
			<spring:message code="hacker.edit.useraccount" />
		</legend>
		...
		<form:label path="userAccount.password">
			<spring:message code="hacker.edit.label.password" />* :
		</form:label>
	...
	<form:label path="conditionsAccepted">
		<spring:message code="hacker.conditions" />:
	</form:label>
	...
	<input type="submit" name="save"
		value="<spring:message code="hacker.edit.save" />" />&nbsp;
